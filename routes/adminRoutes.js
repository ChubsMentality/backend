...
router.route('/disableAdmin/:id').put(disableAdmin)

router.route('/enableAdmin/:id').put(enableAdmin)
...
router.route('/getAdoptionByReference').get(getAdoptionByReference)
